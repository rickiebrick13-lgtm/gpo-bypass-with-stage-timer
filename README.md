...
4. To alter the time, change line 40 within new Date(...) to whatever you expect, according to like 39 comment.
5. To start the whole thing, use CMD or PS, and cd to the folder containing the files then python server.py, and crtl+click the link. 
